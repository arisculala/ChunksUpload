...
public class ChunksUploadServlet extends HttpServlet {
	...
	public static final String FileDir = "/Users/arisculala/Desktop/TEST_UPLOAD/uploadfile/";
			...
			try {
				...
				while (iter.hasNext()) {
				    ...
				    // Handle a multi-part MIME encoded file.
				    	...
				    	String fileDir = FileDir;//req.getSession().getServletContext().getRealPath("/")+FileDir;
